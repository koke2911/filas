...
class Md_usuarios extends Model {
  ...
  public function existe_usuario($usu_cod) {
    ...
    public function datatable_usuarios($db,$id_empresa,$es_admin) {
    ...
    $consulta = "SELECT 
						...
						from 
							usuarios u
						    inner join empresas on empresas.id = u.id_empresa
                ...
                if($es_admin!=1){
                  $consulta.=" where u.id_empresa=$id_empresa";
                }
                // echo $consulta;
